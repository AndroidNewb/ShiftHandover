               ...
               <td><input type="text" id="shiftDate" name="shiftDate" required></td> 
                ...
                <td><select name="currentShift">
                     ...
                     <tr>
                           ...
                           <td colspan="3"><textarea name="completedTasks"
                                         rows="7" cols="110">
</textarea></td>
                     </tr>
                     <tr>
                           <th align="Left"> In Progress tasks  </th>
                           <td colspan="3"><textarea name="inProgressTasks"
                                         rows="7" cols="110">
</textarea> </td>
                     </tr>
                     <tr>
                           <th align="Left"> Issues encountered (Mention the Incident/WO/RFC) </th>
                           <td colspan="3"><textarea name="issues"
                                         rows="7" cols="110">
</textarea> </td>
                     </tr>
                     <tr>
                           <th align="Left"> Changes(RFC): </th>
                           <td colspan="3"><textarea name="changes" rows="7"
                                         cols="110">
</textarea></td>
                     </tr>
                     <tr>
